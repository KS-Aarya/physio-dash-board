...
### Option 0: Quick Admin User Creation (Using Script)

**Fastest way to create the admin user `admincss@test.com`:**

1. **Set up Firebase Admin SDK credentials** (one-time setup):
...
3. **Done!** The admin user `admincss@test.com` with password `admin123` will be created.
